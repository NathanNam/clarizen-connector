    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public LifecycleChangeMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getInputMetaData() {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(EntityId.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ClarizenConnector at lifecycleChange retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
