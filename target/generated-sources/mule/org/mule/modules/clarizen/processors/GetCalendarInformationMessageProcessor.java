    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetCalendarInformationMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(GetCalendarInfoResult.class)));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ClarizenConnector at getCalendarInformation retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
