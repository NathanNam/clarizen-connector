...
/**
 * DeleteEntityMessageProcessor invokes the {@link org.mule.modules.clarizen.ClarizenConnector#deleteEntity(org.mule.modules.clarizen.api.model.BaseClarizenEntity)} method in {@link ClarizenConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final BaseClarizenEntity _transformedEntity = ((BaseClarizenEntity) evaluateAndTransform(getMuleContext(), event, DeleteEntityMessageProcessor.class.getDeclaredField("_entityType").getGenericType(), null, entity));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((ClarizenConnector) object).deleteEntity(_transformedEntity);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ClarizenConnector at deleteEntity retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
