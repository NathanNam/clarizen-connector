    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object queryTypeName;
    protected String _queryTypeNameType;
    ...
    public EntityQueryMessageProcessor(String operationName) {
        super(operationName);
    }
     ...
     * @param value Value to set
     */
    public void setQueryTypeName(Object value) {
        this.queryTypeName = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final List<String> _transformedFieldsToRetrieve = ((List<String> ) evaluateAndTransform(getMuleContext(), event, EntityQueryMessageProcessor.class.getDeclaredField("_fieldsToRetrieveType").getGenericType(), null, fieldsToRetrieve));
            final String _transformedQueryTypeName = ((String) evaluateAndTransform(getMuleContext(), event, EntityQueryMessageProcessor.class.getDeclaredField("_queryTypeNameType").getGenericType(), null, queryTypeName));
            final Condition _transformedCondition = ((Condition) evaluateAndTransform(getMuleContext(), event, EntityQueryMessageProcessor.class.getDeclaredField("_conditionType").getGenericType(), null, condition));
            final Integer _transformedPageSize = ((Integer) evaluateAndTransform(getMuleContext(), event, EntityQueryMessageProcessor.class.getDeclaredField("_pageSizeType").getGenericType(), null, pageSize));
            final Integer _transformedMaxNumberOfPages = ((Integer) evaluateAndTransform(getMuleContext(), event, EntityQueryMessageProcessor.class.getDeclaredField("_maxNumberOfPagesType").getGenericType(), null, maxNumberOfPages));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((ClarizenConnector) object).entityQuery(_transformedFieldsToRetrieve, _transformedQueryTypeName, _transformedCondition, _transformedPageSize, _transformedMaxNumberOfPages);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ClarizenConnector at entityQuery retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
