    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public RetrieveWorkItemHumanResourcesMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(GenericEntity.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ClarizenConnector at retrieveWorkItemHumanResources retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
